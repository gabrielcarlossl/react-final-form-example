...
const InputContainer = styled.input`
  ...
  color: #2f3337;
  border-radius: 9px;
  border: ${(props: any) => (props.error ? `1px solid #e74c3c` : 0)};
...
const Input = (props: InputProps) => {
    ...
    const {input, meta: {error, touched, submitError}} = useField(props.name, {initialValue: props.initialValue, validate: props.validate})
